...
const Carousel = ({
  ...
  const autoplay: React.MutableRefObject<AutoplayType> = useRef(
  ...
  const labelCarousel: LabelCarouselClassName = {
    ...functionalityAlias.component.carousel.main,
  };
  const labelCarouselDots: LabelDots = {
    ...functionalityAlias.component.carousel.carouselDots,
  };
  const labelCarouselButton: LabelButton = {
    ...functionalityAlias.component.carousel.button,
  };
  const labelTextSlide: LabelCarouselSlideTextClassName = {
    ...functionalityAlias.component.carousel.cardReview,
  };
  let classes: LabelCarouselClassName = combineObjects(
    labelCarousel,
    className,
  );
  let classeDots: string = createClassName(
    labelCarouselDots.defaultClassName,
    classNameDots,
  );
  let classesTextSlide: LabelCarouselSlideTextClassName = combineObjects(
    labelTextSlide,
    classNameTextSlide,
  );

  const scrollTo: (index: number) => void | undefined = useCallback(
  ...
  function validateClassName(): void {
    className === undefined
      ? setClassNameObj(labelCarousel)
      : setClassNameObj(className);
  }
