...
const CardHeader = ({
  ...
  return (
    <>
      <a href={labelLink.href} rel={labelLink.rel} target={labelLink.target}>
        <div className={classNameTextSlide?.header}>
          ...
          <div className={classNameTextSlide?.rating}>
            <StarRating rating={reviewCardFields.stars} />
          </div>
          <h5 className={classNameTextSlide?.date}>
            {reviewCardFields.reviewMonth}&nbsp;{reviewCardFields.reviewYear}
            &nbsp;/&nbsp;{reviewCardFields.source}
          </h5>
        </div>
      </a>
    </>
